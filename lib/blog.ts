...
const BASE_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Panel sándwich en Extremadura: fábrica en Badajoz",
    metaDescription:
    ...
    sections: [
      ...
      {
        heading: "Para qué se construye con panel en Extremadura",
        paragraphs: [
          "Extremadura es tierra de campo, y eso marca lo que se construye. El grueso de lo que sale de fábrica son cubiertas de nave agrícola y ganadera: almacenes de cereal y de fruta, secaderos, cobertizos de maquinaria, granjas y explotaciones de la dehesa. La economía agraria de Badajoz y Cáceres levanta naves de forma continua, campaña tras campaña, y el panel sándwich es la respuesta rápida y aislada a esa demanda.",
          "Junto a la nave agrícola conviven los polígonos industriales de Mérida, Badajoz, Cáceres, Don Benito o Almendralejo, con talleres, logística y pequeña industria que también se cubren con panel. Y crece la demanda en vivienda y rehabilitación, sobre todo de panel imitación teja para casas de campo y cascos rurales donde se busca la estética tradicional con el aislamiento y la ligereza del panel.",
        ],
        bullets: [
          "Naves agrícolas: almacenes, secaderos y cobertizos de maquinaria por toda la región.",
          "Ganadería: granjas y salas que piden Agropanel con cara interior anticorrosión.",
          "Industria y logística: polígonos de Mérida, Badajoz, Cáceres y las Vegas Altas.",
          "Vivienda rural: panel imitación teja para casas de campo y rehabilitación de tejados.",
        ],
      },
      {
        heading: "El clima extremeño manda en la elección",
        paragraphs: [
          "El clima de Extremadura es exigente y conviene tenerlo presente al elegir el panel. Los veranos son largos y muy calurosos, con jornadas que superan los 40 grados y una insolación intensa durante meses. Bajo ese sol, una cubierta sin aislar convierte la nave en un horno y dispara la temperatura de lo que se guarda dentro, así que aquí no recomendamos el espesor mínimo, sino el que pide el uso real del edificio.",
          "El invierno trae el extremo contrario, con heladas y madrugadas frías que provocan condensación bajo las cubiertas mal resueltas. Un buen espesor de núcleo frena ambos extremos, y el color claro en cubierta ayuda a reflejar el sol y a calentar menos la nave. Son detalles que decidimos contigo según la orientación del edificio y lo que vaya a albergar, porque conocemos el terreno y preferimos acertar antes que vender de más.",
        ],
      },
      {
        heading: "Cómo pedir presupuesto y qué plazos manejamos",
        paragraphs: [
          "Pedir presupuesto es sencillo: con las medidas de la cubierta o la fachada —y, si los hay, un croquis o unas fotos— preparamos una propuesta cerrada con el panel, los remates y el transporte incluidos. Cuanto más claras sean las medidas, más ajustado sale el precio y menos sorpresas hay en obra. Se puede hacer por WhatsApp, por teléfono o desde la página de contacto, sin compromiso.",
          "En cuanto a plazos, al fabricar nosotros mismos controlamos los tiempos: planificamos la producción y el transporte para dar una fecha realista, sin prometer entregas imposibles. Para pedidos pequeños o urgencias se puede recoger en la propia planta de Puebla de la Calzada, a pie de la A-5. La cercanía es, al final, la gran ventaja de comprar a una fábrica de la zona.",
        ],
      },
      {
        heading: "Una ubicación pensada para servir al suroeste",
        paragraphs: [
          "La planta de Puebla de la Calzada no está en cualquier sitio: se eligió por su conexión. Está a pie de la A-5, el eje que une Madrid con la frontera portuguesa pasando por Mérida y Badajoz, y bien comunicada con la A-66, la Ruta de la Plata que baja hacia Sevilla y sube hacia Cáceres y Salamanca. Esa posición convierte a la fábrica en un punto natural para servir a todo el cuadrante suroeste de la península.",
          "En la práctica, eso significa portes más cortos y plazos más ajustados para Extremadura, el oeste de Andalucía, el sur de Castilla-La Mancha y el Alentejo portugués, zonas que con los fabricantes del norte y el levante quedan lejos y caras. Comprar a una fábrica que está dentro de tu propia región, o a un par de horas, es una ventaja que se nota tanto en el precio final como en la comodidad de resolver cualquier incidencia.",
        ],
      },
      {
        heading: "Preguntas frecuentes",
        paragraphs: [
          "Las preguntas que más nos hacen los clientes de Extremadura y las provincias limítrofes.",
        ],
        bullets: [
          "¿Dónde está la fábrica de Panelex? En Puebla de la Calzada, Badajoz, a pie de la autovía A-5 y a media hora de la frontera portuguesa.",
          "¿Servís a toda Extremadura? Sí, trabajamos a diario en Badajoz y Cáceres, y enviamos al resto de la región y a las provincias limítrofes.",
          "¿Comprar a fábrica es más barato? Sí: sin intermediarios el precio sale de origen, y cada panel se corta a la medida exacta del faldón para evitar mermas.",
          "¿Lleváis panel a Portugal? Sí, trabajamos habitualmente con clientes portugueses; la frontera está a unos 30 km de la planta.",
          "¿Puedo recoger el pedido en fábrica? Sí, para pedidos pequeños o urgencias se puede recoger en planta; los grandes los llevamos a obra.",
        ],
      },
    ],
    internalLinks: [
