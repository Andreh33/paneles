...
export const PRODUCTS: Product[] = [
  ...
  // ============================================================
  {
    ...
    image: "/products/fp-fertelha.png",
    widthTotal: 1000,
    widthUseful: 1000,
    unit: "m2",
  ...
  // ============================================================
  {
    ...
    image: "/products/fp-pc-tj-1000.png",
    widthTotal: 1000,
    widthUseful: 1000,
    unit: "m2",
    isAgropanel: true,
  ...
  // ============================================================
  {
    ...
    image: "/products/fp-pc-3-1000.png",
    widthTotal: 1000,
    widthUseful: 1000,
    unit: "m2",
    isAgropanel: true,
  ...
  // ============================================================
  {
    ...
    image: "/products/fp-pf-nerv-fn-1000.png",
    widthTotal: 1000,
    widthUseful: 1000,
    unit: "m2",
    specs: expandSpecs([
  ...
  // ============================================================
  {
    ...
    image: "/products/fp-pf-microp-fn-1000.png",
    widthTotal: 1000,
    widthUseful: 1000,
    unit: "m2",
    specs: expandSpecs([
  ...
  // ============================================================
  {
    ...
    image: "/products/fp-pf-never-fo-1000.png",
    widthTotal: 1000,
    widthUseful: 1000,
    unit: "m2",
    specs: expandSpecs([
  ...
  // ============================================================
  {
    ...
    image: "/products/fp-pf-microp-fo-1000.png",
    widthTotal: 1000,
    widthUseful: 1000,
    unit: "m2",
    specs: expandSpecs([
  ...
  // ============================================================
  {
    ...
    image: "/products/acc-cumbrera-fertelha.png",
    widthTotal: 0,
    unit: "ml",
  ...
  },
  {
    ...
    image: "/products/acc-remate-inferior-fertelha.png",
    widthTotal: 0,
    unit: "ml",
    fixedLength: { total: 3.2, useful: 3.0 },
    specs: [{ espesorNominal: 0.45, chapa: "0.45", peso: 0 }],
  },
  {
    ...
    image: "/products/acc-remate-superior-fertelha.png",
    widthTotal: 0,
    unit: "ml",
    fixedLength: { total: 3.2, useful: 3.0 },
    specs: [{ espesorNominal: 0.45, chapa: "0.45", peso: 0 }],
