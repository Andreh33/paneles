...
export const posts: BlogPost[] = [
  {
    slug: "subvenciones-para-cubrir-naves",
    title: "Subvenciones para cubrir naves: tipos de ayudas 2026",
    metaDescription:
      "Qué tipos de subvenciones y ayudas existen para cubrir una nave en 2026: PAC y planes de mejora, líneas autonómicas, eficiencia energética y deducciones.",
    excerpt:
      "Cubrir una nave es una inversión grande y hay ayudas que pueden aligerarla. Repasamos los tipos de subvenciones habituales, qué suelen exigir y cómo preparar el presupuesto sin cometer el error de empezar la obra antes de tiempo.",
    date: "2026-06-30",
    category: "Compra y presupuesto",
    readingMinutes: 14,
    keywords: [
      "subvenciones cubrir nave",
      "ayudas para cubrir naves",
      "subvenciones naves agrícolas",
      "ayudas eficiencia energética nave",
      "subvención panel sándwich",
      "planes de mejora explotaciones",
      "ayudas retirada amianto"
    ],
    sections: [
      {
        heading: "Por qué conviene mirar las ayudas antes de cubrir la nave",
        paragraphs: [
      ...
      {
        heading: "Un aviso honesto: aquí no verás importes ni convocatorias concretas",
        paragraphs: [
      ...
      {
        heading: "Ayudas agrarias: la PAC y los planes de mejora de explotaciones",
        paragraphs: [
      ...
      {
        heading: "Ayudas autonómicas, industriales y de desarrollo rural",
        paragraphs: [
      ...
      {
        heading: "Eficiencia energética y autoconsumo solar: cubrir para gastar menos",
        paragraphs: [
      ...
      {
        heading: "Deducciones fiscales y amortización: la ayuda que no es una subvención",
        paragraphs: [
      ...
      {
        heading: "Ayudas ligadas a retirar amianto o uralita",
        paragraphs: [
      ...
      {
        heading: "Requisitos que se repiten en casi todas las convocatorias",
        paragraphs: [
      ...
      {
        heading: "Documentación y por qué importa un buen presupuesto de fábrica",
        paragraphs: [
      ...
      {
        heading: "Errores frecuentes que dejan una solicitud fuera",
        paragraphs: [
      ...
      {
        heading: "Las ayudas ayudan, pero no deberían ser el único motivo",
        paragraphs: [
      ...
      {
        heading: "Pide presupuesto a fábrica para tu proyecto",
        paragraphs: [
    ...
    internalLinks: [
      { label: "Licencia y trámites para cubrir una nave", href: "/sobre-nosotros/licencia-y-tramites-para-cubrir-nave" },
      { label: "Precio del panel sándwich por m²", href: "/sobre-nosotros/precio-panel-sandwich-m2" },
      { label: "Adiós a la uralita: sustituir fibrocemento", href: "/sobre-nosotros/panel-sandwich-vs-fibrocemento-adios-uralita" },
      { label: "Pide presupuesto", href: "/contacto" }
    ]
  },
  {
    slug: "licencia-y-tramites-para-cubrir-nave",
    title: "Licencia de obra: trámites para cubrir o construir una nave",
    metaDescription:
      "Qué licencia y trámites necesitas para cubrir o construir una nave: obra mayor o menor, licencia municipal, suelo rústico o industrial y proyecto técnico.",
    excerpt:
      "Cubrir una nave también tiene papeleo. Te explicamos cuándo es obra mayor o menor, qué licencia municipal necesitas, en qué se diferencia el suelo rústico del industrial y cuándo hace falta proyecto técnico.",
    date: "2026-06-29",
    category: "Guías técnicas",
    readingMinutes: 15,
    keywords: [
      "licencia obra nave",
      "trámites cubrir nave",
      "licencia de obra municipal",
      "nave en suelo rústico",
      "proyecto técnico nave",
      "permisos construir nave",
      "obra mayor obra menor"
    ],
    sections: [
      {
        heading: "Cubrir una nave no es solo montar el panel",
        paragraphs: [
      ...
      {
        heading: "Obra menor u obra mayor: la primera pregunta que lo cambia todo",
        paragraphs: [
      ...
      {
        heading: "La licencia de obra municipal: el trámite base",
        paragraphs: [
      ...
      {
        heading: "Declaración responsable y comunicación previa: la vía rápida",
        paragraphs: [
      ...
      {
        heading: "Suelo rústico o suelo industrial: dónde está tu nave",
        paragraphs: [
      ...
      {
        heading: "Cuándo necesitas proyecto técnico y dirección de obra",
        paragraphs: [
      ...
      {
        heading: "Otros permisos que pueden aparecer según el caso",
        paragraphs: [
      ...
      {
        heading: "La documentación habitual de un expediente",
        paragraphs: [
      ...
      {
        heading: "Tasas, impuesto de construcciones y plazos",
        paragraphs: [
      ...
      {
        heading: "El papel del fabricante: datos para el proyecto y el expediente",
        paragraphs: [
      ...
      {
        heading: "Consejos para que el trámite no te frene la obra",
        paragraphs: [
      ...
      {
        heading: "Pide presupuesto y prepara tu obra con nosotros",
        paragraphs: [
