...
export const posts: BlogPost[] = [
  {
    slug: "panel-sandwich-vs-fibrocemento-adios-uralita",
    ...
    readingMinutes: 12,
    keywords: [
      "cambiar uralita por panel sándwich",
      "retirada de amianto",
      "sustituir uralita",
    ...
    sections: [
      {
        heading: "Qué es la uralita y por qué conviene cambiarla",
        paragraphs: [
      ...
      {
        heading: "El amianto: por qué la retirada es obligatoria y quién puede hacerla",
        paragraphs: [
      ...
      {
        heading: "Por qué el panel sándwich es el sustituto natural de la uralita",
        paragraphs: [
      ...
      {
        heading: "Cómo es el proceso de sustitución, paso a paso",
        paragraphs: [
      ...
      {
        heading: "Ayudas y subvenciones para retirar el amianto",
        paragraphs: [
      ...
      {
        heading: "Qué panel elegir para sustituir tu uralita",
        paragraphs: [
      ...
      {
        heading: "Cómo lo fabricamos y servimos desde Badajoz",
        paragraphs: [
    ...
    internalLinks: [
      ...
      { label: "Fábrica en Extremadura", href: "/panel-sandwich-extremadura" }
    ]
  },
  {
    slug: "panel-sandwich-vs-chapa-simple-galvanizada",
    title: "Panel sándwich vs chapa: cuándo merece la pena cada uno",
    metaDescription: "Panel sándwich vs chapa simple galvanizada: aislamiento, condensación, ruido y coste comparados. Te decimos cuándo basta la chapa y cuándo hace falta panel.",
    excerpt: "El panel sándwich vs la chapa simple no es una pelea de buenos y malos: cada uno tiene su sitio. La chapa es más barata y resuelve cobertizos y espacios abiertos; el panel aísla, no condensa y silencia la lluvia. Te contamos en qué se diferencian de verdad y cómo elegir sin gastar de más.",
    date: "2026-04-14",
    category: "Comparativas",
    readingMinutes: 12,
    keywords: [
      "panel sándwich vs chapa",
      "chapa simple galvanizada",
      "condensación cubierta chapa",
      "aislamiento cubierta",
      "chapa perfilada o panel",
      "ruido lluvia cubierta"
    ],
    sections: [
      {
        heading: "Qué es la chapa simple y qué es el panel sándwich",
        paragraphs: [
      ...
      {
        heading: "Aislamiento térmico: la diferencia que más se nota",
        paragraphs: [
      ...
      {
        heading: "Condensación: el problema invisible de la chapa",
        paragraphs: [
      ...
      {
        heading: "Ruido bajo la lluvia y el granizo",
        paragraphs: [
      ...
      {
        heading: "Durabilidad y coste: la compra frente al largo plazo",
        paragraphs: [
      ...
      {
        heading: "Cuándo basta la chapa y cuándo hace falta panel",
        paragraphs: [
      ...
      {
        heading: "Cómo te servimos chapa y panel desde Badajoz",
        paragraphs: [
  ...
  {
    slug: "panel-sandwich-vs-teja-ceramica",
    title: "Panel sándwich vs teja cerámica: peso, obra y aislamiento",
    metaDescription: "Panel sándwich vs teja cerámica: pesa 10 veces menos, se monta en días y ya viene aislado. Vemos coste, mantenimiento y cuándo gana la teja real.",
    excerpt: "El panel sándwich imitación teja te da el aspecto de un tejado de toda la vida pesando una décima parte, ya aislado y montado en días en lugar de semanas. Pero la teja cerámica no está muerta: en según qué obras sigue teniendo sentido. Comparamos peso, plazo, aislamiento, coste y estética con sinceridad.",
    date: "2026-04-21",
    category: "Comparativas",
    readingMinutes: 12,
    keywords: [
      "panel sándwich vs teja",
      "panel imitación teja",
      "panel sándwich teja Fertelha",
      "tejado panel sándwich",
      "peso teja cerámica",
      "cambiar teja por panel"
    ],
    sections: [
      {
        heading: "Dos formas de tener un tejado con aspecto de teja",
        paragraphs: [
      ...
      {
        heading: "El peso: hasta diez veces menos",
        paragraphs: [
      ...
      {
        heading: "Plazo de obra: días frente a semanas",
        paragraphs: [
      ...
      {
        heading: "Aislamiento incluido frente a tejado aislado aparte",
        paragraphs: [
      ...
      {
        heading: "Coste total instalado y mantenimiento a largo plazo",
        paragraphs: [
      ...
      {
        heading: "Estética y gama Fertelha: ¿se nota?",
        paragraphs: [
      ...
      {
        heading: "Cuándo la teja cerámica sigue ganando",
        paragraphs: [
    ...
    internalLinks: [
      ...
      { label: "Ver gama imitación teja", href: "/productos" },
      { label: "Consúltanos", href: "/contacto" }
    ]
  },
  {
    slug: "panel-sandwich-vs-onduline",
    title: "Panel sándwich vs onduline: aislamiento y durabilidad reales",
    metaDescription: "Panel sándwich vs onduline o placa bituminosa: comparamos aislamiento, durabilidad, resistencia y usos. Cuándo conviene el panel y cuándo basta el bituminoso.",
    excerpt: "Las placas bituminosas tipo onduline son baratas, ligeras y fáciles de poner, pero no aíslan ni duran como un panel sándwich. Ni una cosa ni la otra es mala: cada una sirve para algo distinto. Te explicamos en qué gana cada material y cuándo el bituminoso resuelve un apaño y cuándo necesitas panel de verdad.",
    date: "2026-04-28",
    category: "Comparativas",
    readingMinutes: 12,
    keywords: [
      "panel sándwich vs onduline",
      "placa bituminosa cubierta",
      "onduline o panel sándwich",
      "cubierta bituminosa aislamiento",
      "panel sándwich cobertizo",
      "alternativa al onduline"
    ],
    sections: [
      {
        heading: "Qué es una placa bituminosa tipo onduline y qué es el panel sándwich",
        paragraphs: [
      ...
      {
        heading: "Aislamiento: la diferencia de fondo",
        paragraphs: [
      ...
      {
        heading: "Durabilidad y resistencia frente al sol y el tiempo",
        paragraphs: [
      ...
      {
        heading: "Resistencia mecánica: viento, granizo y pisadas",
        paragraphs: [
      ...
      {
        heading: "Usos: para qué sirve bien cada uno",
        paragraphs: [
      ...
      {
        heading: "Por qué para una construcción permanente conviene el panel",
        paragraphs: [
    ...
    internalLinks: [
      { label: "Fertelha chocolate", href: "/productos/fertelha-chocolate" },
      { label: "Panel de cubierta en rojo", href: "/productos/panel-cubierta-rojo" },
