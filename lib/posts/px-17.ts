...
export const posts: BlogPost[] = [
  {
    slug: "como-retirar-uralita-con-amianto",
    ...
    readingMinutes: 15,
    keywords: [
      "retirar uralita amianto",
      "retirada de uralita",
      "empresa RERA amianto",
      "sustituir uralita por panel sándwich",
      "quitar fibrocemento",
      "cubierta de uralita",
      "amianto en cubierta"
    ],
    sections: [
      {
        heading: "Qué es la uralita y por qué preocupa el amianto",
        paragraphs: [
      ...
      {
        heading: "El amianto está prohibido en España: el marco legal",
        paragraphs: [
      ...
      {
        heading: "Solo una empresa inscrita en el RERA puede retirarla",
        paragraphs: [
      ...
      {
        heading: "Por qué nunca debes retirar la uralita por tu cuenta",
        paragraphs: [
      ...
      {
        heading: "Cómo es el proceso de retirada, paso a paso",
        paragraphs: [
      ...
      {
        heading: "Amianto no friable: por qué la uralita empeora con los años",
        paragraphs: [
      ...
      {
        heading: "Documentación y trazabilidad: qué papeles debes guardar",
        paragraphs: [
      ...
      {
        heading: "Qué hacemos nosotros: el panel nuevo, no el amianto",
        paragraphs: [
      ...
      {
        heading: "De la uralita al panel sándwich: qué ganas con el cambio",
        paragraphs: [
      ...
      {
        heading: "Cómo planificar la sustitución completa",
        paragraphs: [
      ...
      {
        heading: "Pide presupuesto del panel nuevo",
        paragraphs: [
    ...
    internalLinks: [
      { label: "Del fibrocemento al panel: adiós a la uralita", href: "/sobre-nosotros/panel-sandwich-vs-fibrocemento-adios-uralita" },
      { label: "Sobrecubierta: tapar la uralita sin retirarla", href: "/sobre-nosotros/sobrecubierta-sobre-uralita-con-panel" },
      { label: "Cómo instalar panel sándwich en cubierta", href: "/sobre-nosotros/como-instalar-panel-sandwich-cubierta" },
      { label: "Pide presupuesto", href: "/contacto" }
    ]
  },
  {
    slug: "sobrecubierta-sobre-uralita-con-panel",
    ...
    readingMinutes: 15,
    keywords: [
      "sobrecubierta uralita",
      "tapar uralita con panel sándwich",
      "sobrecubierta panel sándwich",
      "cubrir uralita sin retirar",
      "encapsular amianto",
      "sobrecubierta amianto",
      "reformar cubierta de fibrocemento"
    ],
    sections: [
      {
        heading: "Qué es una sobrecubierta sobre uralita",
        paragraphs: [
      ...
      {
        heading: "Tapar no es retirar: qué significa dejar el amianto debajo",
        paragraphs: [
      ...
      {
        heading: "Cuándo es viable tapar la uralita sin retirarla",
        paragraphs: [
      ...
      {
        heading: "Cuándo NO es viable y hay que retirar",
        paragraphs: [
      ...
      {
        heading: "Ventajas de la sobrecubierta",
        paragraphs: [
      ...
      {
        heading: "Inconvenientes y límites que debes conocer",
        paragraphs: [
      ...
      {
        heading: "El punto delicado: fijar la estructura sin liberar fibras",
        paragraphs: [
      ...
      {
        heading: "Cómo se resuelve técnicamente con panel sándwich",
        paragraphs: [
      ...
      {
        heading: "Estructura y cargas: comprobar antes de tapar",
        paragraphs: [
      ...
      {
        heading: "Normativa, licencia y seguridad",
        paragraphs: [
      ...
      {
        heading: "Qué hacemos nosotros y qué no",
        paragraphs: [
      ...
      {
        heading: "Pide presupuesto de tu sobrecubierta",
        paragraphs: [
    ...
    internalLinks: [
      { label: "Del fibrocemento al panel: adiós a la uralita", href: "/sobre-nosotros/panel-sandwich-vs-fibrocemento-adios-uralita" },
      { label: "Cómo retirar la uralita con amianto", href: "/sobre-nosotros/como-retirar-uralita-con-amianto" },
