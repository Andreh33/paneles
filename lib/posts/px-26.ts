...
export const posts: BlogPost[] = [
  {
    slug: "reparar-o-sustituir-un-panel-danado",
    title: "Cómo reparar o sustituir un panel sándwich dañado paso a paso",
    metaDescription: "Guía para reparar o sustituir un panel sándwich dañado: diagnóstico, arañazos, agujeros, núcleo mojado y cambio de lama cortada a medida en Badajoz.",
    excerpt: "Un golpe, un tornillo mal puesto o una gotera no siempre obligan a cambiar el panel entero. Te enseñamos a diagnosticar el daño, reparar arañazos y agujeros, saber cuándo el núcleo mojado obliga a sustituir y cómo cambiar una lama en cubierta o fachada.",
    date: "2026-06-14",
    category: "Mantenimiento",
    readingMinutes: 16,
    keywords: [
      "sustituir panel dañado",
      "reparar panel sandwich",
      "cambiar panel sandwich cubierta",
      "reparar chapa cubierta",
      "mantenimiento panel sandwich",
      "sellar agujero panel sandwich",
      "panel sandwich Badajoz"
    ],
    sections: [
      {
        heading: "Un panel dañado no siempre hay que tirarlo",
        paragraphs: [
      ...
      {
        heading: "Tipos de daño más habituales en un panel",
        paragraphs: [
      ...
      {
        heading: "Primero diagnostica: superficial o de fondo",
        paragraphs: [
      ...
      {
        heading: "Reparar o sustituir: la pregunta clave",
        paragraphs: [
      ...
      {
        heading: "Cómo reparar daños superficiales",
        paragraphs: [
      ...
      {
        heading: "Cómo tapar perforaciones y agujeros pequeños",
        paragraphs: [
      ...
      {
        heading: "Cuándo el núcleo mojado obliga a sustituir",
        paragraphs: [
      ...
      {
        heading: "Cómo sustituir un panel completo en cubierta",
        paragraphs: [
      ...
      {
        heading: "Sustituir un panel de fachada con fijación oculta",
        paragraphs: [
      ...
      {
        heading: "Herramientas, materiales y seguridad",
        paragraphs: [
      ...
      {
        heading: "Mantenimiento preventivo para no llegar a sustituir",
        paragraphs: [
      ...
      {
        heading: "Pide presupuesto a fábrica",
        paragraphs: [
    ...
    internalLinks: [
      { label: "Cómo reparar goteras en cubierta de panel", href: "/sobre-nosotros/como-reparar-goteras-en-cubierta-de-panel" },
  ...
  {
    slug: "aislar-una-nave-por-dentro-con-panel",
    title: "Aislar una nave por dentro con panel sándwich: trasdosado",
    metaDescription: "Cómo aislar una nave por dentro con panel sándwich: trasdosado, qué panel usar, subestructura y cómo evitar la condensación. Fabricamos a medida en Badajoz.",
    excerpt: "Muchas naves son un horno en verano y una nevera en invierno. Aislarlas por dentro con panel sándwich es rápido y económico, pero tiene una trampa: la condensación. Te explicamos qué panel usar, cómo montar el trasdosado y cómo evitar que la cámara gotee.",
    date: "2026-06-13",
    category: "Aplicaciones",
    readingMinutes: 15,
    keywords: [
      "aislar nave por dentro",
      "trasdosado panel sandwich",
      "aislar nave con panel",
      "falso techo panel sandwich",
      "aislamiento interior nave",
      "condensacion trasdosado",
      "panel sandwich Extremadura"
    ],
    sections: [
      {
        heading: "Por qué aislar una nave por dentro",
        paragraphs: [
      ...
      {
        heading: "Cuándo conviene aislar por dentro y cuándo por fuera",
        paragraphs: [
      ...
      {
        heading: "Qué panel usar para el trasdosado",
        paragraphs: [
      ...
      {
        heading: "Aislar las paredes: el trasdosado paso a paso",
        paragraphs: [
      ...
      {
        heading: "Aislar el techo por debajo: falso techo de panel",
        paragraphs: [
      ...
      {
        heading: "El gran riesgo: la condensación entre el panel viejo y el nuevo",
        paragraphs: [
      ...
      {
        heading: "Ventilación y barrera de vapor: cómo evitarlo",
        paragraphs: [
      ...
      {
        heading: "Subestructura y fijación del panel interior",
        paragraphs: [
      ...
      {
        heading: "Puentes térmicos y continuidad del aislamiento",
        paragraphs: [
      ...
      {
        heading: "Qué núcleo elegir: PIR, PUR o lana de roca",
        paragraphs: [
      ...
      {
        heading: "Confort real, coste y cuándo llamar a un profesional",
        paragraphs: [
